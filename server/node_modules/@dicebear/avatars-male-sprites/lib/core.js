...
exports.style = {
    ...
    create: ({ prng, options }) => {
        let skinColor = prng.pick([
            ...
            new color_1.default('#F5CFA0'),
            new color_1.default('#EAC393'),
            new color_1.default('#E0B687'),
            new color_1.default('#CB9E6E'),
            new color_1.default('#B68655'),
            new color_1.default('#A26D3D'),
        ...
        let mouthColor = prng
            .pick([new color_1.default('#eec1ad'), new color_1.default('#dbac98'), new color_1.default('#d29985')])
        ...
        while (mouth.length === 0) {
            if (undefined === options.mood || options.mood.indexOf('sad') > -1) {
                // prettier-ignore
                mouth.push(`<path d="M8 13h3v1H8v-1z" fill="${mouthColor.hex}"/>`, `<path d="M8 13h4v1H8v-1z" fill="${mouthColor.hex}"/>`, `<path d="M9 13h2v1H9v-1z" fill="${mouthColor.hex}"/>`, `<path d="M8 12v1h3v1h1v-1h-1v-1H8z" fill="${mouthColor.hex}"/>`, `<path d="M8 13v1h1v-1h3v-1H9v1H8z" fill="${mouthColor.hex}"/>`);
            }
            if (undefined === options.mood || options.mood.indexOf('happy') > -1) {
                // prettier-ignore
                mouth.push(`<path d="M7 12v1h1v1h4v-1H8v-1H7z" fill="${mouthColor.hex}"/>`, `<path d="M10 12v1H9v1h2v-2h-1z" fill="${mouthColor.hex}"/>`, `<path d="M8 13v1h4v-1h1v-1h-1v1H8z" fill="${mouthColor.hex}"/>`, `<path d="M8 12v2h4v-2H8z" fill="#FFF"/>`);
            }
            if (undefined === options.mood || options.mood.indexOf('surprised') > -1) {
                // prettier-ignore
                mouth.push(`<path d="M9 12v2h2v-2H9z" fill="${mouthColor.hex}"/>`, `<path d="M9 13v1h1v-1H9z" fill="${mouthColor.hex}"/>`);
            }
            if (mouth.length === 0) {
